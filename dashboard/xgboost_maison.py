...
# y_proba et y_pred existent il sont calculer en haut 
enregistrer_resultats("XGBoost maison", y_test, y_pred, y_proba)
os.makedirs("artefacts/modeles", exist_ok=True)
joblib.dump(trees, "artefacts/modeles/XGBoost maison.pkl")   