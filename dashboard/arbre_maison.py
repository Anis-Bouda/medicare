...
# Sauvgarde les résultats pour les comparer avec les autres modeles 


y_pred = arbre_maison.predict(X_test_np)
enregistrer_resultats("Arbre maison", y_test_np, y_pred, y_pred)   # pas de proba
os.makedirs("artefacts/modeles", exist_ok=True)
joblib.dump(arbre_maison, "artefacts/modeles/Arbre maison.pkl")