...
X_train_proc, X_dev_proc, X_test_proc, y_train, y_dev, y_test, preprocess = preparer_donnees()
...
#modif pour comparer les resultat 
enregistrer_resultats("XGBoost", y_test, y_pred, y_prob)
os.makedirs("artefacts/modeles", exist_ok=True)
joblib.dump(best_model, "artefacts/modeles/XGBoost.pkl")
