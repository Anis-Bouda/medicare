...
# on aura un tableau : count, mean, std, min, max ,25%,50%,75%
print(data.describe())
...
#1er separation :
#70% train
#30% temporaire, qui sera ensuite divise en dev et test
...
#memme si nous n'avons pas encore entraine de modele, le preprocesseur
#doit lui aussi apprendre certaines informations a partir des donnee
#par exemple StandardScaler apprend la moyenne et l'ecart-type des
#colonnes numeriques et OneHotEncoder apprend les categories presentes
#dans les colonnes categorielles
#
#pour eviter que les donnees de dev et de test influencent cette etape
#on apprend le pretraitement uniquement sur X_train avec fit_transform()
#ensuite on applique exactement les memes regles a X_dev et X_test
#avec transform() sans reapprendre de nouvelles informations
