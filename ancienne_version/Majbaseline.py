...
# =========================
# majority baseline code a la main
# =========================
...
# entrainement seulement avec y_train
# le modele apprend juste la classe la plus frequente dans le train
majority_model.fit(y_train_np)

# prediction sur dev
y_dev_pred_majority = majority_model.predict(X_dev_np)

print("Predictions Majority Baseline :")
print(y_dev_pred_majority[:40])

print("Vraies valeurs :")
print(y_dev_np[:40])

# evaluation
print("Accuracy :", accuracy_score(y_dev_np, y_dev_pred_majority))

print("Precision High :", precision_score(y_dev_np, y_dev_pred_majority, pos_label=1))
print("Recall High :", recall_score(y_dev_np, y_dev_pred_majority, pos_label=1))
print("F1 High :", f1_score(y_dev_np, y_dev_pred_majority, pos_label=1))

print("Precision Low :", precision_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0))
print("Recall Low :", recall_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0))
print("F1 Low :", f1_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0))

print("Matrice de confusion :")
print(confusion_matrix(y_dev_np, y_dev_pred_majority))

print("Rapport de classification :")
print(classification_report(y_dev_np, y_dev_pred_majority, zero_division=0))

resultat = pd.DataFrame([{
    "modele": "Majority Baseline maison",
    "accuracy": accuracy_score(y_dev_np, y_dev_pred_majority),
    "precision_high": precision_score(y_dev_np, y_dev_pred_majority, pos_label=1, zero_division=0),
    "recall_high": recall_score(y_dev_np, y_dev_pred_majority, pos_label=1, zero_division=0),
    "f1_high": f1_score(y_dev_np, y_dev_pred_majority, pos_label=1, zero_division=0),
    "precision_low": precision_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0),
    "recall_low": recall_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0),
    "f1_low": f1_score(y_dev_np, y_dev_pred_majority, pos_label=0, zero_division=0)
}])
