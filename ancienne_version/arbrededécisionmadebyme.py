...
# ces metriques servent a evaluer les performances du modele
...
# =========================
# test de l arbre de decision maison
# =========================

# on utilise dabord un echantillon pour eviter que le code soit trop lent
#X_train_sample = X_train_np[:5000]
#y_train_sample = y_train_np[:5000]

#X_dev_sample = X_dev_np[:1000]
#y_dev_sample = y_dev_np[:1000]
...
# entrainement du modele
#arbre_maison.fit(X_train_sample, y_train_sample)
# entrainement du modele sur tout le train
arbre_maison.fit(X_train_np, y_train_np)

# prediction sur dev
#y_dev_pred = arbre_maison.predict(X_dev_sample)
...
print(y_dev_np[:40])
#print("Accuracy :", accuracy_score(y_dev_sample, y_dev_pred))
#print("Precision :", precision_score(y_dev_sample, y_dev_pred))
#print("Recall :", recall_score(y_dev_sample, y_dev_pred))
#print("F1-score :", f1_score(y_dev_sample, y_dev_pred))

#print("Matrice de confusion :")
#print(confusion_matrix(y_dev_sample, y_dev_pred))

print("Accuracy :", accuracy_score(y_dev_np, y_dev_pred))
print("Precision :", precision_score(y_dev_np, y_dev_pred))
print("Recall :", recall_score(y_dev_np, y_dev_pred))
print("F1-score :", f1_score(y_dev_np, y_dev_pred))
...
resultat.to_csv("resultat_arbre_by_me.csv", index=False)